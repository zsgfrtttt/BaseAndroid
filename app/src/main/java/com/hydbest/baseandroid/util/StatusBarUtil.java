...
public class StatusBarUtil {
     ...
     * 为content设置padding
     */
    public static void setFitsSystemWindows(Activity activity,boolean fill) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (content != null) {
                content.setFitsSystemWindows(fill);
    ...
    public static boolean isStatusBarTransparent(Activity activity) {
        boolean is = (activity.getWindow().getAttributes().flags &= WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS) == WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS;
        Log.i("csz", "isis :" + is);
        return is;
    }
}
