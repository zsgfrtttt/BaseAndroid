...
public class ViewUtilsLollipop {
    ...
    public  static final int[] STATE_LIST_ANIM_ATTRS = new int[]{android.R.attr.stateListAnimator};
    ...
    public static void setStateListAnimatorFromAttrs(@NonNull View view, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        @SuppressLint("RestrictedApi") final TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, STATE_LIST_ANIM_ATTRS, defStyleAttr, defStyleRes);
        try {
            if (a.hasValue(0)) {
     ...
     */
    public static void setDefaultAppBarLayoutStateListAnimator(@NonNull final View view, final float elevation) {
        ...
        sla.addState(new int[]{android.R.attr.enabled, R.attr.state_liftable, -R.attr.state_lifted}, ObjectAnimator.ofFloat(view, "elevation", 0f).setDuration(dur));
