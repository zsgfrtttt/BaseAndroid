 ...
 */
package com.hydbest.baseandroid.drawable.shadow;
 ...
 */
public class RoundDrawableWithShadow extends Drawable {
    ...
    static {
        if (Build.VERSION.SDK_INT >= 17) {
            SHADOW = new ShaowApi17();
        } else {
            SHADOW = new ShadowBase();
        }
        SHADOW.initialize();
    }

    public RoundDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        mShadowStartColor = resources.getColor(R.color.cardview_shadow_start_color);
        mShadowEndColor = resources.getColor(R.color.cardview_shadow_end_color);
        Log.i("csz",mShadowStartColor+"  j  "+ mShadowEndColor);
