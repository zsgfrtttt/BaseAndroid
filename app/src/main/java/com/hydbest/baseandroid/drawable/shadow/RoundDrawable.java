...
public class RoundDrawable extends Drawable {
    ...
    public RoundDrawable(ColorStateList backgroundColor, float radius) {
        mRadius = radius;
    ...
    private void updateBounds(Rect bounds) {
        ...
        mBoundsI.set(bounds);
        if (mInsetForPadding) {
            float vInset = RoundDrawableWithShadow.calculateVerticalPadding(mPadding, mRadius, mInsetForRadius);
            float hInset = RoundDrawableWithShadow.calculateHorizontalPadding(mPadding, mRadius, mInsetForRadius);
