...
public class ImageWatcherHelper {
    ...
    private ImageWatcher.OnDelListener onDelListener;
    ...
    public ImageWatcherHelper setOnDelListener(ImageWatcher.OnDelListener listener){
    ...
    private void init() {
        ...
        if (onDelListener !=null) mImageWatcher.setOnDelListener(onDelListener);
