...
import com.hydbest.baseandroid.databinding.DetailViewBinding;
...
public class DetailViewPagerAdapter extends PagerAdapter {
    ...
    private void onViewBound(DetailViewBinding binding) {
        Glide.with(host)
                ...
                .apply(new RequestOptions().placeholder(R.color.placeholder).override(ImageSize.NORMAL[0], ImageSize.NORMAL[1]))
                .into(binding.photo);
    }
