...
internal class CheeseGridAdapter(
        ...
        return CheeseViewHolder(parent).apply {
            itemView.setOnClickListener { view ->
                ...
                view.findNavController().navigate(
                        ...
                        CheeseDetailFragmentArgs.Builder(cheese.id).build().toBundle(),
                        null,
    ...
    override fun onBindViewHolder(holder: CheeseViewHolder, position: Int) {
        ...
        var requestBuilder = Glide.with(holder.image).load(cheese.image).apply(RequestOptions().dontTransform().priority(Priority.IMMEDIATE))
